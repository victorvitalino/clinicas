class ClinicsController < ApplicationController
  ...
  private
    ...
    def clinic_params
      params.require(:clinic).permit(:name, :cnpj, :social_name, :fantasy_name, :address, :neighborhood, :city, :state, :cep, :phone, :fax, :celphone, :representative_name, :representative_phone, :geolocation, :nusai, :procedure_class_id)
    end
end
